import { WeatherAlert } from '../../../app/models/weather/weather-alert.models';
import { WeatherData } from '../../../app/models/weather/weather-data.models';

export const TEST_WEATHER_ALERT_TITLE_SINGLE =
  'Tropical Cyclone Alert from PAGASA-DOST (07/10/2021 5:11:08 pm — 08/10/2021 6:10:58 am)';

export const TEST_WEATHER_ALERT_TITLE_MULTIPLE_OR_EMPTY = 'Weather Alerts';

export const TEST_WEATHER_ALERT: WeatherAlert = {
...
export const TEST_WEATHER_ALERTS: WeatherAlert[] = [TEST_WEATHER_ALERT];

export const TEST_WEATHER_DATA: WeatherData = {
  lat: 10.3646,
  lon: 123.9164,
